! function (e, t) {
    ...
    var e = {
            372: (e, t, n) => {
                ...
                var x = n(860);
                const E = n.n(x)().getLogger("modules/API/external/functions.js");
                ...
                class D extends(i()) {
                    constructor(e) {
                        ...
                        }(n), E = o.getItem("jitsiLocalStorage");
                        this._parentNode = c, this._url = function (e) {
                            return function (e) {
                                let t;
                                ...
                                url: `https://${e}/#jitsi_meet_external_api_id=${P}`
                            })
                        }(e, {
                            configOverwrite: l,
                            iceServers: y,
                            ...
                            release: C
                        }), this._createIFrame(a, s, x), this._transport = new k({
                            backend: new b({
                                postisOptions: {
                                    allowedOrigin: new URL(this._url).origin,
                                    scope: `jitsi_meet_external_api_${P}`,
                                    window: this._frame.contentWindow
                                }
                            })
                        }), Array.isArray(v) && v.length > 0 && this.invite(v), this._onload = p, this._tmpE2EEKey = L, this._isLargeVideoVisible = !1, this._isPrejoinVideoVisible = !1, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), P++
                    }
                    _createIFrame(e, t, n) {
                        const r = `jitsiConferenceFrame${P}`;
            ...
            620: e => {
                ...
                function l(e, t, n, r) {
                    ...
                    if (void 0 === o) {
                        ...
                        r ? o.unshift(n) : o.push(n);
                    }
                
                    // Ensure that the max listeners warning is disabled or handled silently
                    return e;
                }
