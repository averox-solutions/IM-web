...
//         // Add interval to refresh every 5 seconds
//         this.refreshInterval = setInterval(async () => {
//             // Refresh poll data if poll instance exists
//             if (this.state.poll) {
//                 try {
//                     // Force refresh by getting responses again
//                     const responses = await this.state.poll.getResponses();
//                     // Manually trigger the responses change event
//                     this.onResponsesChange(responses);
//                 } catch (error) {
//                     console.warn("Failed to refresh poll data:", error);
//                 }
//             }
//         }, 5000);
//     }
...
//         // Listen for event replacements (edits)
//         this.props.mxEvent.on(MatrixEventEvent.Replaced, this.onEventReplaced.bind(this));
//     }
...
//         // Remove event replacement listener
//         this.props.mxEvent.off(MatrixEventEvent.Replaced, this.onEventReplaced.bind(this));
//     }
...
//         // When the poll event is edited, force a re-render to show the updated question
//         this.forceUpdate();
//     };
